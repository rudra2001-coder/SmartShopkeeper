...
fun AddEditSupplierScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { BengaliText(text = if (supplier == null) "নতুন সরবরাহকারী" else "সরবরাহকারী সম্পাদনা", fontSize = 20.sp, fontWeight = FontWeight.Bold) },
                navigationIcon = {
