    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                BengaliText(text = product.name, fontWeight = FontWeight.Bold, fontSize = 16.sp)
                BengaliText(text = "ক্রয়মূল্য: ${product.costPrice} | বিক্রয়মূল্য: ${product.salePrice}", fontSize = 14.sp)
            }
            BengaliText(text = "স্টক: ${product.stockQty}", fontSize = 14.sp)
        }
    }
}
